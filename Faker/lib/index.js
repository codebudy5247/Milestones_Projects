...
function Faker (opts) {
  ...
  /*
  self is not a reserved keyword or standard type, but has
  become a defacto standard name when for keeping reference
  to an object for closures.
  */
